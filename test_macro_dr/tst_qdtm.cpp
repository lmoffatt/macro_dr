...
TEST_CASE("Test Qdtm ", "[Qdtm]")
{
    ...
    auto Maybe_param1 = var::load_Parameters<MyModel>(
        parfile, ",", model0.model_name(), model0.names());
    ...
    auto func_table=macrodr::cmd::get_function_Table_maker_St("../macro_dr/test_macro_dr/examples/tst.txt",0ul)();
    ...
    double dt=1e-3;
    auto Maybe_Qdt=macrodr::Macro_DMR{}.calc_Qdt_eig(func_table,m,Qx_eig,macrodr::number_of_samples(10),dt);
    auto Maybe_Qdt_Taylor=macrodr::Macro_DMR{}.calc_Qdt_taylor(m,Qx,macrodr::number_of_samples(10),1e-3,10);
    REQUIRE(Maybe_Qdt);
    auto r_Qdt=std::move(Maybe_Qdt.value());
    
    auto Maybe_Qdtm=macrodr::Macro_DMR{}.calc_Qdtm_eig(func_table,m,Qx_eig,macrodr::number_of_samples(10),dt);
    ...
    auto Maybe_Qdt2=macrodr::Macro_DMR{}.calc_Qdt_eig(func_table,m,Qx_eig,macrodr::number_of_samples(20),2*dt);
    ...
    auto Maybe_Qdtm_2=macrodr::Macro_DMR{}.calc_Qdtm_eig(func_table,m,Qx_eig,macrodr::number_of_samples(10),2e-3);
