...
//  auto filename = "../macro_dr/test.txt";
  ...
  auto Efilename = "../macro_dr/Moffatt_Hume_2007_ATP.txt";
...
//  aram_0 = State_Model_Parameters ( values = { { "kon"  50 }  { "koff"   20 }  { "beta"  500 }  { "alfa"  400 } { "g"  16.59e-3 } {"Number_of_Channels"  100}  { "gaussian_noise"  1.0e-5 } } )
  ...
  Patch_Model model1(N_St(5),
                     Q0(Matrix<double>(5,5,0.0)), Qa(Matrix<double>(5,5,0.0)), g(Matrix<double>(5,1,0.0)), N_Ch_mean(100), N_Ch_std(2.0), curr_noise(10.0), min_P(1e-5), Probability_error_tolerance(1e-2), Conductance_variance_error_tolerance(1e-2));
  
  get<Qa>(model1)()(0,1)=18;
  get<Qa>(model1)()(1,2)=12;
  get<Qa>(model1)()(2,3)=6;
  get<Q0>(model1)()(1,0)=100;
  get<Q0>(model1)()(2,1)=200;
  get<Q0>(model1)()(3,2)=300;
  ...
  auto lik=Macro_DMR{}.log_Likelihood(model1,experiment);
