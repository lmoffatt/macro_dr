...
int main(int argc, char **argv) {
  ...
  Patch_Model model1(
      N_St(5), Q0(Matrix<double>(5, 5, 0.0)), Qa(Matrix<double>(5, 5, 0.0)),
      g(Matrix<double>(5, 1, 0.0)), N_Ch_mean(100), N_Ch_std(2.0),
      curr_noise(1e-5), min_P(1e-7), Probability_error_tolerance(1e-2),
