...
\title{Likelihood Information Distortion in Gaussian Predictive Inference}
\author{}
\date{}
...
To compare these two geometries, we introduce the Likelihood Information Distortion,
\begin{equation}
