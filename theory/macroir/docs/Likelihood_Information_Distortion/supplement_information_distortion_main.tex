...
\title{Supplementary Information: Likelihood Information Distortion, Effective Sample Size, Corrected Covariance, and Bias}
\author{}
\date{}
...
\section*{4. Likelihood Information Distortion (LID)}

The total Likelihood Information Distortion is
\begin{equation}
\mathbf C(\theta)
=
\mathbf H^{-1/2}
...
\section*{6. Likelihood Distortion-Corrected Covariance (DCC)}
...
\section*{7. Likelihood Distortion-Induced Bias (DIB)}
...
Accordingly, the total Likelihood Information Distortion and Likelihood Sample Distortion are evaluated on $\mathrm{range}(\mathbf H)$:
\begin{equation}
\mathbf C_H
=
\mathbf \Lambda_H^{-1/2}
...
If $\mathbf J_{\mathrm{sample}}$ is singular, the Likelihood Correlation Distortion is defined on the retained eigenspace of $\mathbf J_{\mathrm{sample}}$ instead:
\begin{equation}
...
\section*{9. Effective Sample Size and Likelihood Correlation Distortion}
...
Define the Likelihood Correlation Distortion
\begin{equation}
\mathbf R
=
...
\section*{10. Likelihood Sample Distortion and Decomposition}

Define the Likelihood Sample Distortion
\begin{equation}
...
The total Likelihood Information Distortion decomposes as
\begin{equation}
\mathbf C
=
...
\mathbf C &\rightarrow \text{total likelihood information distortion}, \\
\mathbf C_{\mathrm{sample}} &\rightarrow \text{likelihood sample distortion}, \\
\mathbf R &\rightarrow \text{likelihood correlation distortion}, \\
\Sigma_{\mathrm{DCC}} &\rightarrow \text{likelihood distortion-corrected covariance}, \\
\mathbf b_{\mathrm{DIB}} &\rightarrow \text{likelihood distortion-induced bias}.
\end{align}
