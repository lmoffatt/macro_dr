...
inline void calc_thermo_evidence_dts(std::string id, std::string model,
                                 ...
                                 std::size_t sampling_interval,std::size_t max_number_of_values_per_iteration, std::size_t myseed) {
...
inline void calc_thermo_evidence_dts_2(std::string id, std::string model,
                                     std::string prior,
                                     likelihood_algo_type likelihood,
                                     std::string recording,
                                     experiment_file_type experiment_file,
    ...
    auto ftbl3 = cmd::get_function_Table_maker_St_no_Qdt_memoization(filename, sampling_interval,max_number_of_values_per_iteration)();
...
inline void calc_thermo_evidence_dts_continuation_2(std::string id, std::size_t ith, std::size_t myinit_seed) {
    ...
    auto ftbl3 = get_function_Table_maker_St_no_Qdt_memoization(newfilename, sampling_interval,max_number_of_values_per_iteration)();
