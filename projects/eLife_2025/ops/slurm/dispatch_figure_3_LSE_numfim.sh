...
#   projects/eLife_2025/ops/slurm/dispatch_figure_3_LSE_numfim.sh <cluster>     # e.g. dirac
...
#     projects/eLife_2025/ops/slurm/dispatch_figure_3_LSE_numfim.sh dirac
#   # chain after a build job:  DEPEND=<jobid> projects/eLife_2025/ops/slurm/dispatch_figure_3_LSE_numfim.sh dirac
