...
#   projects/eLife_2025/ops/slurm/dispatch_figure_3_LSE.sh <cluster>     # e.g. dirac
...
#   # chain after a build job:  DEPEND=<jobid> projects/eLife_2025/ops/slurm/dispatch_figure_3_LSE.sh dirac
