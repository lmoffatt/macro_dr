...
**Figure 4. Where in time each parameter is measured, and the per-step calibration of that information, along the recursive ladder.**
...
<!-- Source: projects/eLife_2025/figures/paper/figure_4.Rmd, roster ALGOS <- c("R","MR","VR","IR").
