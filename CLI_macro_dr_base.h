...
inline dcli::Compiler make_utilities_compiler() {
    dcli::Compiler cm;
...
inline dcli::Compiler make_experiment_compiler() {
    dcli::Compiler cm;
...
inline dcli::Compiler make_model_compiler() {
    dcli::Compiler cm;
...
inline dcli::Compiler make_frac_compiler() {
    dcli::Compiler cm;
    cm.push_function(
        "fraction_experiment",
