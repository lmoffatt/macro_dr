...
inline auto set_ThermoAlgorithm(std::size_t num_scouts_per_ensemble,
                                ...
                                std::size_t beta_medium_size, std::size_t thermo_jumps_every,
                                std::size_t save_every_param_size_factor) {
    ...
    return std::tuple(num_scouts_per_ensemble, number_trials_until_give_up, thermo_jumps_every,
                      ...
                      beta_upper_value, beta_medium_value, stops_at, includes_zero,
                      save_every_param_size_factor);
}

using thermo_algo_type = typename return_type<std::decay_t<decltype(&set_ThermoAlgorithm)>>::type;
...
inline void calc_thermo_evidence(std::string id, std::string model, std::string prior,
                                 likelihood_algo_type likelihood, std::string recording,
                                 experiment_file_type experiment_file,
                                 thermo_algo_type thermo_algorithm, std::size_t sampling_interval,
...
inline void calc_thermo_evidence_continuation(std::string id, std::size_t ith,
