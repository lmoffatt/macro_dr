...
inline auto i_fract_beta_to_global_beta(std::vector<std::size_t> const& i_fracs,
...
inline auto global_beta_to_S(const std::vector<double>& beta) {
...
inline auto S_t0_global_beta(const std::vector<double>& S) {
...
template <class Parameters>
std::map<std::size_t, double> calculate_logL_mean(ensemble<fraction_mcmc<Parameters>> const& wa,
                                                  const std::vector<std::size_t>& i_fracs) {
    std::map<std::size_t, double> sum;
...
template <class Parameters>
by_beta<std::map<std::size_t, double>> calculate_logL_mean(
...
inline auto S_to_i_fract_beta(std::vector<double> const& S, std::vector<std::size_t> num_samples,
                              std::size_t max_samples) {
    auto frac_samples =
...
inline auto global_beta_to_i_fract_beta(std::vector<double> const& global_beta,
                                        std::vector<std::size_t> p_i_frac,
                                        std::vector<std::size_t> num_samples,
                                        std::size_t max_samples, double threshold) {
...
inline auto i_frac_to_i_fracs(const std::vector<std::size_t>& i_frac) {
...
inline auto init_fraction_mcmc(FunctionTable& f, mt_64i& mt, Prior const& pr, const Lik& lik,
...
inline auto get_samples_size(auto const& y) {
