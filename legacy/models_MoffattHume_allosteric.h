...
static auto scheme_5 = Allost1::Model("scheme_5", []() {
    ...
    auto mo = make_Conformational_model_standarized(
        Agonist_dependency_map{std::map<Conformational_change_label, Agonist_dependency>{
            {v_binding, Agonist_dependency{Agonist_label{"ATP"}}},
            {v_gating, Agonist_dependency{}}}},
        std::vector<Conformational_change_label>{v_binding, v_binding, v_binding, v_gating},
        std::vector<Conformational_interaction>{{
            Vector_Space{Conformational_interaction_label{"BG"},
        ...
        std::map<Conformational_change_label, Conformation_change_standard_state>{
            ...
            {v_gating, Conformation_change_standard_state{Conformational_interactions_domain_state{
                           std::map<Vector_Space<Conformational_interaction_index,
                                                 Conformational_interaction_subposition>,
                                    int>{{Vector_Space{Conformational_interaction_index{0ul},
    ...
    auto names_vec =
        std::vector<std::string>{"Binding_on", "Binding_off", "Gating_on",     "Gating_off", "BG",
                                 "BG_0",       "BG_1",        "Gating_Current"};  //--> 8

    auto names_other = std::vector<std::string>{"Current_Noise", "Pink_Noise", "Proportional_Noise",
                                                "Current_Baseline", "Num_ch"};

    auto p_kinetics = std::vector<double>{5.85, 190, 769, 10.2, 49.6 * 4.51, 4.51, 4.58, 1};
    ...
    auto [a_Q0_formula, a_Qa_formula, a_g_formula] = std::move(Maybe_modeltyple_formula.value());
    return std::tuple(
        [names, m](const auto& t_p)
            -> Maybe_error<Transfer_Op_to<std::decay_t<decltype(t_p)>, Patch_Model>> {
            ...
            if (!Maybe_v_P_initial)
                ...
                return build<Patch_Model>(
                    ...
                    std::move(Maybe_v_P_initial.value()), std::move(a_g), build<N_Ch_mean>(v_N0),
        ...
        [names, m](const auto& patch_model)
            ...
            auto par =
                get_Parameters_from_Q0_Qa_g(m, names, get<Q0>(patch_model), get<Qa>(patch_model),
            ...
            auto out =
                Transfer_Op_to<std::decay_t<decltype(patch_model)>, Matrix<double>>(Npar + 5, 1);
...
static auto scheme_6 = Allost1::Model("scheme_6", []() {
    ...
    auto mo = make_Conformational_model_standarized(
        Agonist_dependency_map{std::map<Conformational_change_label, Agonist_dependency>{
            ...
            {v_gating, Agonist_dependency{}}}},
        std::vector<Conformational_change_label>{v_binding, v_binding, v_binding, v_rocking,
                                                 v_gating},
        std::vector<Conformational_interaction>{
            {Vector_Space{Conformational_interaction_label{"BR"},
                          Conformational_interaction_players{{v_binding, v_rocking}},
                          Conformational_interaction_positions{{{0, 3}, {1, 3}, {2, 3}}}},
             Vector_Space{Conformational_interaction_label{"BG"},
                          Conformational_interaction_players{{v_binding, v_gating}},
                          Conformational_interaction_positions{{{0, 4}, {1, 4}, {2, 4}}}},
             Vector_Space{Conformational_interaction_label{"RG"},
        ...
        std::map<Conformational_change_label, Conformation_change_standard_state>{
            {v_rocking, Conformation_change_standard_state{Conformational_interactions_domain_state{
                            std::map<Vector_Space<Conformational_interaction_index,
                                                  Conformational_interaction_subposition>,
                                     int>{{Vector_Space{Conformational_interaction_index{0ul},
                                                        Conformational_interaction_subposition{1}},
            ...
            {v_gating, Conformation_change_standard_state{Conformational_interactions_domain_state{
                           std::map<Vector_Space<Conformational_interaction_index,
                                                 Conformational_interaction_subposition>,
                                    int>{{Vector_Space{Conformational_interaction_index{1ul},
                                                       Conformational_interaction_subposition{1}},
                                          3},
    ...
    auto p_kinetics = std::vector<double>{9.28, 1871, 3875, 1.07, 914, 776,  65.1 * 1.15, 1.15,
...
static auto scheme_7 = Allost1::Model("scheme_7", []() {
    ...
    auto mo = make_Conformational_model_standarized(
        Agonist_dependency_map{std::map<Conformational_change_label, Agonist_dependency>{
            ...
            {v_binding, Agonist_dependency{Agonist_label{"ATP"}}},
            {v_gating, Agonist_dependency{}}}},
        std::vector<Conformational_change_label>{v_binding, v_rocking, v_binding, v_rocking,
                                                 v_binding, v_rocking, v_gating},
        std::vector<Conformational_interaction>{
            {Vector_Space{Conformational_interaction_label{"BR"},
                          Conformational_interaction_players{{v_binding, v_rocking}},
    ...
    auto p_kinetics = std::vector<double>{12.0, 6731, 9035, 242,  1380,       110,  4295, 4295,
...
3}*/}}}}},
    ...
    auto names_other =
        std::vector<std::string>{"Gating_Current",     "Current_Noise",    "Pink_Noise",
                                 "Proportional_Noise", "Current_Baseline", "Num_ch"};

    auto p_kinetics = std::vector<double>{10.0, 10000, 10000, 100, 10, 1, 1, 1, 10, 1e-6};
    ...
    return std::tuple(
        ...
        [names, m](const auto& patch_model)
            ...
            auto out =
                Transfer_Op_to<std::decay_t<decltype(patch_model)>, Matrix<double>>(Npar + 6, 1);
...
static auto scheme_9 = Allost1::Model("scheme_9", []() {
    ...
    auto mo = make_Conformational_model_standarized(
        ...
        std::vector<Conductance_interaction>{
            Vector_Space{Conductance_interaction_label{"Rocking_Current_factor"},
                         Conductance_interaction_players{{v_rocking}},
                         Conductance_interaction_positions{{{{1}}, {{3}}, {{5}}}}}},
        std::map<Conformational_change_label, Conformation_change_standard_state>{
            {v_rocking, Conformation_change_standard_state{Conformational_interactions_domain_state{
    ...
    auto p_kinetics = std::vector<double>{10.0, 10000, 10000, 100, 10, 1, 1, 10, 1e-6};
    auto p_other = std::vector<double>{1, 1e-3, 5, 1e-2, 1, 4800};
...
static auto scheme_10 = Allost1::Model("scheme_10", []() {
    ...
    auto p_kinetics = std::vector<double>{10.0, 10000, 10000, 100, 10, 1, 1, 10, 1, 1, 10, 1e-6};
    auto p_other = std::vector<double>{1, 1e-3, 5, 1e-2, 1, 4800};
...
static auto scheme_11 = Allost1::Model("scheme_11", []() {
        ...
        std::vector<Conformational_interaction>{
            {Vector_Space{Conformational_interaction_label{"RB"},
             ...
             Vector_Space{
                 Conformational_interaction_label{"RBR"},
                 Conformational_interaction_players{{v_rocking, v_binding, v_rocking}},
                 Conformational_interaction_positions{{{5, 0, 1}, {1, 2, 3}, {3, 4, 5}}}}}},
        std::vector<Conductance_interaction>{
            Vector_Space{Conductance_interaction_label{"Rocking_Current_factor"},
                         Conductance_interaction_players{{v_rocking}},
                         Conductance_interaction_positions{{{{1}}, {{3}}, {{5}}}}}},
    ...
    auto p_kinetics =
        std::vector<double>{10.0, 10000, 10000, 100, 10, 1, 1, 10, 1, 1, 1, 1, 1, 1, 10, 1e-6};
    auto p_other = std::vector<double>{1, 1e-3, 5, 1e-2, 1, 4800};
...
static auto scheme_12 = Allost1::Model("scheme_12", []() {
    ...
    auto p_kinetics =
        std::vector<double>{10.0, 10000, 10000, 100, 1000, 100, 10, 1, 1, 1, 100, 10, 10, 1};
    auto p_other = std::vector<double>{1e-3, 5, 1e-2, 1, 4800};
...
static auto scheme_13 = Allost1::Model("scheme_13", []() {
    ...
    auto names_vec = std::vector<std::string>{
        "Binding_on", "Binding_off", "Rocking_on",    "Rocking_off", "Gating_on",
        "Gating_off", "RB",          "RB_0",          "RB_1",        "RG",
        "RG_0",       "RG_1",        "Gating_Current"};  //--> 8

    auto names_other = std::vector<std::string>{"Current_Noise", "Pink_Noise", "Proportional_Noise",
                                                "Current_Baseline", "Num_ch"};

    auto p_kinetics =
        std::vector<double>{10.0, 10000, 10000, 100, 1000, 100, 10, 1, 1, 100, 10, 10, 1};
    auto p_other = std::vector<double>{1e-3, 5, 1e-2, 1, 4800};
...
static auto scheme_14 = Allost1::Model("scheme_14", []() {
    ...
    auto mo = make_Conformational_model_standarized(
        ...
        std::map<Conformational_change_label, Conformation_change_standard_state>{
            ...
            {v_gating, Conformation_change_standard_state{Conformational_interactions_domain_state{
                           std::map<Vector_Space<Conformational_interaction_index,
                                                 Conformational_interaction_subposition>,
                                    int>{{Vector_Space{Conformational_interaction_index{2ul},
                                                       Conformational_interaction_subposition{1}},
    ...
    auto p_kinetics =
        std::vector<double>{10.0, 10000, 10000, 100, 1000, 100, 10, 1, 1, 10, 1, 1, 100, 10, 10, 1};
    auto p_other = std::vector<double>{1e-3, 5, 1e-2, 1, 4800};
...
static auto scheme_15 = Allost1::Model("scheme_15", []() {
    ...
    auto mo = make_Conformational_model_standarized(
        ...
        std::map<Conformational_change_label, Conformation_change_standard_state>{
            ...
            {v_gating, Conformation_change_standard_state{Conformational_interactions_domain_state{
                           std::map<Vector_Space<Conformational_interaction_index,
                                                 Conformational_interaction_subposition>,
                                    int>{{Vector_Space{Conformational_interaction_index{3ul},
                                                       Conformational_interaction_subposition{1}},
    ...
    auto names_vec = std::vector<std::string>{
        "Binding_on", "Binding_off", "Rocking_on", "Rocking_off", "Gating_on",
        "Gating_off", "RB",          "RB_0",       "RB_1",        "BR",
        "BR_0",       "BR_1",        "RBR",        "RBR_0",       "RBR_1",
        "RBR_2",      "RG",          "RG_0",       "RG_1",        "Gating_Current"};  //--> 8

    auto names_other = std::vector<std::string>{"Current_Noise", "Pink_Noise", "Proportional_Noise",
                                                "Current_Baseline", "Num_ch"};

    auto p_kinetics = std::vector<double>{10.0, 10000, 10000, 100, 1000, 100, 10,  1,  1,  10,
