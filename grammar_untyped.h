...
class untyped_literal : public untyped_expression<Lexer, Compiler> {
   ...
   public:
    virtual Maybe_unique<dcli::base_typed_expression<Lexer, Compiler>> compile_expression(
...
class untyped_assignment : public untyped_statement<Lexer, Compiler> {
   ...
   public:
    virtual Maybe_unique<dcli::base_typed_statement<Lexer, Compiler>> compile_statement(
        Compiler& cm) const override {
