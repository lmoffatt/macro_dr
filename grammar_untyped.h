...
public:
  ...
  virtual std::string type_of_statement() const { return statement_type(); }
  static std::string statement_type() { return "untyped_simple_expression"; }

  untyped_literal(std::string t_expression)
...
public:
  ...
  compile(const Compiler &cm) const {
...
public:
  ...
  virtual std::string str() const {
    return std::string(Lexer::comment_start) +
           untyped_literal<Lexer, Compiler>::str();
  }
...
public:
  untyped_argument_list(
      const std::vector<std::unique_ptr<untyped_statement<Lexer, Compiler>>>
          &t_list)
      : m_list{dcli::clone(t_list)} {}

  untyped_argument_list(
      std::vector<std::unique_ptr<untyped_statement<Lexer, Compiler>>>
          &&t_list)
      : m_list{t_list} {}
  untyped_argument_list(const untyped_argument_list &other)
      : m_list{dcli::clone_vector(other.m_list)} {}

  untyped_argument_list(untyped_argument_list &&other)
      : m_list{std::move(other.t_list)} {}

  untyped_argument_list() {}

  auto &arg() const { return m_list; }

  untyped_argument_list &
  push_back(untyped_statement<Lexer, Compiler> *t_expr) {
...
public:
  ...
  auto &fid() const { return *m_fid; }
  auto &args() const { return *m_arg; }
