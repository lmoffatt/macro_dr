...
- **[Q] Length.** eLife's guidance is under 5,000 words for the main text excluding Methods, references and legends. Six paragraphs at ~130 words is ~800, which is right for a paper whose Results carry five figures. Do not let the literature review swell: the quotations are load-bearing, the paraphrase around them is not.
