...
$\bar{y}^{\mathrm{pred}}_{0\to\Delta}$ from Eq.~\ref{eq:ypred}, and assigns one constant fitted
variance to every residual. There is no gain, so no occupancy object is ever conditioned on the
data. It is the anchor of the comparison rather than a member of the family.
