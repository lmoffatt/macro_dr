...
\[
  \underbrace{\boldsymbol{\mu}^\top\boldsymbol{\gamma}}_{\text{the mean}}
  \qquad
  \underbrace{\boldsymbol{\mu}^\top\mathbf{w}}_{\text{the state-dependent noise}}
  \qquad
  \underbrace{\boldsymbol{\gamma}^\top\boldsymbol{\Sigma}\boldsymbol{\gamma}}_{\text{what the state contributes}}
  \qquad
  \underbrace{\boldsymbol{\Sigma}\boldsymbol{\gamma}}_{\text{state against current},\ \mathbf{g}}
\]
...
\begin{equation}
  ...
  + \underbrace{\mathbb{E}\bigl[\mathrm{Var}(\bar y \mid \mathbf{N}_0)\bigr]}_{N_{\mathrm{ch}}\,\boldsymbol{\mu}_0^\top\mathbf{w}}
  + \underbrace{\mathrm{Var}\bigl[\mathbb{E}(\bar y \mid \mathbf{N}_0)\bigr]}_{N_{\mathrm{ch}}\,\bar{\boldsymbol{\gamma}}_{0}^\top\boldsymbol{\Sigma}_0\bar{\boldsymbol{\gamma}}_{0}} ,
  \label{eq:ltv}
\end{equation}
