...
variance, by two decompositions that rearrange into each other (Appendix~1), so what
...
covariance, and the conditioning step that consumes them are derived in the Theory
section and its supplement; we do not restate them here, beyond the regularizer of
Eq.~\ref{eq:pseudocount} below.
