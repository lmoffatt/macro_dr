...
sat on lines 158 and 162 of the retired `abstract_draft.md`, whose successor is `SPINE.md` (Abstract)).
**Settled by B-4 at 10-16**, recorded in `decisions/D-4_ranking_verdict.md` §4 and in
`SPINE.md` (Results); 14-21 is a real number about a different object. It was never Luciano's to settle. Note
...
| **B-3** | Draft the replacement novelty paragraph from `docs/bibliography/MacroIR_prior_art_map.md`, plus the one-line retraction of the claim now in `SPINE.md` (Introduction). | `decisions/D-3_novelty_claim.md`, written 2026-07-15 | Luciano approves in 10 min |
...
collapses to its single confirming branch (`decisions.md`; no two-branch `SPINE.md` (Results) needed). What is
