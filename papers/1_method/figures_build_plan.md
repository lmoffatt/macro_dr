...
> what a figure *shows* (`docs/manuscript-drafts/sections/04_results.md`), the eLife/visual rules (`../_program/figures_system.md`), or
...
superseding the 2026-07-20 two-column call (`decisions.md`, `docs/manuscript-drafts/sections/04_results.md`).
...
with `docs/manuscript-drafts/sections/04_results.md`, which implies every five-algorithm figure. Enumerate it or drop the count.
...
- Fig 4's anchor and threshold conflicts, already open in `docs/manuscript-drafts/sections/04_results.md`.
