...
| `check.sh` | the done-oracle + index completeness, **taking the paper as an argument** | LIVE | done 2026-07-20: it sits at `_program/check.sh`, takes the paper folder as its argument, and item 9 checks this index. Item 11, added 2026-08-26, checks that figures are cited in numerical order, since production numbers display items by first citation in the text and would otherwise renumber the whole set. Do **not** triplicate it |
...
5. The five real rewrites, one at a time, each touching a thesis: `00_plan.md` and `1_method/decisions.md`
   ...
   section plans were consolidated into `1_method/docs/manuscript-drafts/sections/README.md` on 2026-07-29 rather than rewritten.**
