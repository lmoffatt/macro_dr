...
- [ ] Read and edit `papers/macroir-elife-2025/00_master_plan.md`
- [ ] Fill/confirm open decisions in `papers/macroir-elife-2025/02_decision_log.md`
- [ ] Edit thresholds + definitions in `papers/macroir-elife-2025/03_metrics_diagnostics.md`
- [ ] Confirm the 4-figure storyboard in `papers/macroir-elife-2025/04_figures_storyboard.md`
...
- [ ] Resolve known TODOs in `papers/macroir-elife-2025/docs/manuscript-drafts/elife-macroir-merged.tex`
...
- [ ] Confirm grid definition in `papers/macroir-elife-2025/05_experiment_grid.md`
...
- [ ] If needed, schedule code tasks from `papers/macroir-elife-2025/07_code_tasks.md` as separate commits
